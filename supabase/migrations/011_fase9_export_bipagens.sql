-- RotaScan — Fase 9: função de export (linhas detalhadas) para o Dashboard
-- Idempotente: pode ser executado múltiplas vezes sem erro.
--
-- Mesmos filtros de dashboard_kpis (010_fase8_dashboard_kpis.sql) e mesmo
-- raciocínio de SECURITY INVOKER (RLS de bipagens/operacoes isola por
-- galpão automaticamente). Retorna um único JSON (json_agg dentro de uma
-- única linha) para não ser afetado pelo limite de 1000 linhas do
-- PostgREST — só o LIMIT interno (20000) protege o tamanho do payload.
